...
public class Order implements Serializable {
	...
	@OneToOne(mappedBy = "order", cascade = CascadeType.ALL)		// cascade eh obrigatorio pq a relacao eh 1 para 1 e o id de Order será o mesmo id para Payment
